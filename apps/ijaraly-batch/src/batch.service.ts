...
import { Member } from 'apps/ijaraly-api/src/libs/dto/member/member';
import { Property } from 'apps/ijaraly-api/src/libs/dto/property/property';
import { MemberStatus, MemberType } from 'apps/ijaraly-api/src/libs/enums/member.enum';
import { PropertyStatus } from 'apps/ijaraly-api/src/libs/enums/property.enum';
...
export class BatchService {
  ...
  public getHello(): string {
    return 'Welcome to Ijaraly-Batch Server!';
  }
}
